...
namespace PFAPI.utility
{
    ...
    {
        public static string Encrypt(string text, string salts)
        {
            return Encrypt(text, TransferStringtoBytes(salts));
        }
        public static string Decrypt(string text, string salts)
        {
            return Decrypt(text, TransferStringtoBytes(salts));
        }
        ...
        private static byte[] TransferStringtoBytes(string inPutString=null)
        {
            byte[] ba = null;
            ...
            //    IntPtr unmanagedBytes = Marshal.SecureStringToGlobalAllocAnsi(inPutString);
            //    try
            //    {
