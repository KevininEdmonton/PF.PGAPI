...
namespace PFAPI.Controllers
{
    ...
    public class HouseController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        ...
        private string _curDataModelName = "HousewPrice";
        ...
        /// <summary>
        /// Get a list of HousewPrice Model
        /// </summary>
        ...
        /// <returns>An ActionResult of PagedData for existing HousewPrice Models</returns>
        ...
        public async Task<ActionResult<List<HousewPrice>>> GetList(int qp_page = PFAPIStatics.SYS_Default_QP_Page
                                                                ...
                                                                , string qp_filter = PFAPIStatics.SYS_Default_QP_Filter)
        {
            try
            {
                List<HousewPrice> theResult = DataHelper.GetHouseList();
                return Ok(theResult);
                ...
                //{
                //    var theResult = await _repository_clientdb.CreatePagedResults<HousewPrice, HousewPrice>(theQueryParameter);
                //    return Ok(theResult);
                //}
            }
            catch (Exception e)
     ...
     //   [ProducesResponseType(StatusCodes.Status200OK)]
     //   [ProducesResponseType(StatusCodes.Status500InternalServerError)]
     //   public async Task<ActionResult<PagedData<HousewPrice>>> Get(int qp_page = PFAPIStatics.SYS_Default_QP_Page
     //                                                           , int qp_pagesize = PFAPIStatics.SYS_Default_QP_Pagesize
     //                                                           , string qp_orderby = PFAPIStatics.SYS_Default_QP_Orderby
     //                                                           , bool qp_includeallchildrendata = PFAPIStatics.SYS_Default_QP_IncludeAllChildrenData
     //                                                           , string qp_includedata = PFAPIStatics.SYS_Default_QP_IncludeData
     ...
     //   /// <summary>
     //   /// Get one HousewPrice Model
     //   /// </summary>
     //   /// <param name="id">HousewPrice ID</param>
     //   /// <param name="qp_includeallchildrendata">Whether get all children data</param>
     //   /// <param name="qp_includedata">Specific children data that need to be get; one level lower only; split by [,]</param>
     //   /// <returns>An ActionResult of existing HousewPrice Model</returns>
     //   [Authorize(Policy4ModuleOperations.P_AccountAccessLevel.AccessLevel_EveryOne)]
     ...
     //   public async Task<ActionResult<HousewPrice>> Get(int id, bool qp_includeallchildrendata = PFAPIStatics.SYS_Default_QP_IncludeAllChildrenData
     //                                                           , string qp_includedata = PFAPIStatics.SYS_Default_QP_IncludeData)
     //   {
     //       try
     //       {
     ...
     //           using (IPFClientRepository _repository_clientdb = PFClientRepository.CreateRepositoryInstance(_config, _mapper, Guid.Empty))
     //           {
     //               IQueryable<HousewPrice> theQuery = _repository_clientdb.GetQueryable<HousewPrice>();
     //               theQuery = theQuery.Where(o => o.Id == id);

     //               HousewPrice theDataModel = await _repository_clientdb.GetOneDataModel<HousewPrice, HousewPrice>(theQueryParameter, theQuery);
     ...
     //   }
        ...
        ///// <summary>
        ///// Create a new HousewPrice Model
        ///// </summary>
        ///// <param name="model">HousewPrice Model to be created</param>
        ///// <returns>An ActionResult of newly created HousewPrice Model</returns>
        ///// <remarks>
        ///// Sample request:
        /////     POST                         \
        /////     {                            \
        ...
        //public async Task<ActionResult<HousewPrice>> Post(HousewPrice model)
        //{
        //    try
        //    {
        //        using (IPFClientRepository _repository_clientdb = PFClientRepository.CreateRepositoryInstance(_config, _mapper, Guid.Empty))
        ...
        //            //if (_repository_clientdb.GetExists<HousewPrice>($"Name=='{model.Name}'"))
        //            //{
        ...
        //            // Create new 
        //            model.Id = Guid.Empty;
        //            HousewPrice entity = await MappingHelper.StarndardMap<HousewPrice, HousewPrice>(_repository_clientdb, _mapper, model, Guid.Empty);
        ...
        //            return Created(newUri, _mapper.Map<HousewPrice>(entity));
        //        }
        //    }
        //    catch (Exception e)
        //    {
        ...
        ///// <summary>
        ///// Update a existing HousewPrice Model
        ///// </summary>
        ///// <param name="id">HousewPrice ID</param>
        ///// <param name="model">HousewPrice Model to be updated</param>
        ///// <returns>An ActionResult of updated HousewPrice Model</returns>
        //////[HttpPatch("{id}")]
        ...
        //[ProducesResponseType(StatusCodes.Status422UnprocessableEntity,
        //    Type = typeof(Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary))]
        //public async Task<ActionResult<HousewPrice>> Put(Guid id, HousewPrice model)
        //{
        //    try
        //    {
        ...
        //        using (IPFClientRepository _repository_clientdb = PFClientRepository.CreateRepositoryInstance(_config, _mapper, Guid.Empty))
        //        {
        //            var existingentity = _repository_clientdb.GetById<HousewPrice>(id);
        ...
        //            //// Name should be Unique
        //            //if (_repository_clientdb.GetExists<HousewPrice>($"Name=='{model.Name}' and ID != GUID('{model.Id}')"))
        //            //{
        //            //    return BadRequest($"Name [{model.Name}] is in Use;");
        //            //}
        ...
        //            existingentity = await MappingHelper.StarndardMap<HousewPrice, HousewPrice>(_repository_clientdb, _mapper, model, id);
        ...
        //                {
        //                    return _mapper.Map<HousewPrice>(existingentity);
        //                }
        //                else
        //                {
        ...
        //            if (await _repository_clientdb.SaveChangesAsync(this.User))
        //            {
        //                return Ok(_mapper.Map<HousewPrice>(existingentity));
        //            }
        ...
        ///// <summary>
        ///// Delete a existing HousewPrice Model
        ///// </summary>
        ///// <param name="id">HousewPrice ID</param>
